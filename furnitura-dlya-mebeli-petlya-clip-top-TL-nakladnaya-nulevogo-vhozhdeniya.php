                    ...
                    <article    id="petli-dlya-fasadov-TL">
                      <section >
                        ...
                        <div class="bs-callout bs-callout-warning cont" > 
                            ...
                            <div class="main-box clearfix"  id="petlya-nakladnaya-nulevogo-vhozhdeniya-TL" >   
                                  ...
                                  <div class="row" style="margin-bottom: 15px; margin-left: 15px;">
                                    <div class="row col-xs-12 col-sm-12 col-md-12" style="background: #fff;
                                        ...
                                        <div class="row col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">                                                           
                                            <div class="row">                                                
                                                <h3 class="blum">5000502-01-114</h3>
                                                <h3 class="blum">Петля накладная нулевого вхождения для профильных дверей 155° CLIP top BLUMOTION без пружины 70T7550.TL, чашка петли: на шурупы</h3>
                                                <p> <a href="furnitura-dlya-mebeli-petlya-clip-top-nakladnaya-nulevogo-vhozhdeniya.php#petlya-nakladnaya-nulevogo-vhozhdeniya" >
                                                ...
                                                <table class="table table-striped table-responsive">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>1</td>
                                                            <td class="animated" data-objfurnid="29"><a href="https://publications.blum.com/2018/catalogue/ru/104/#zoom=z" target="_blank">70T7550.TL</a></td>
                                                            <td>Металл</td> 
                                                            <td colspan="3">пeтля накладная нулевого вхождения CLIP top BLUMOTION без пружины</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>1</td>
                                                            <td class="" ><a href="https://publications.blum.com/2018/catalogue/ru/214/#zoom=z" target="_blank">70T3504</a></td>
                                                            <td>Металл</td> 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>4</td>
                                                            <td class="" ><a href="https://www.mdm-complect.ru/catalog/futorki/10229/" target="_blank">BU17PN</a></td>
                                                            <td>Белый</td> 
