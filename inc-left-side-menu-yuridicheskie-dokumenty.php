                        ...
                        <li class="menu">
                            <a href="yuridicheskie-dokumenty.php" class="list-group-item  '.$item_dogovor_Class.'">Договор основной</a>
                             <ul class="list-group sub_menu">
                                <li class="menu2"><a class="list-group-item sub dblstr-lg" href="#soglashenie-o-vnesenii-izmeneniy-v-stoimost-dogovora">Соглашение о внесении изменений в СТОИМОСТЬ Договора</a>                                
                                </li>
                                <li class="menu2"><a class="list-group-item sub" href="#soglashenie-o-vnesenii-izmeneniy-v-sroki-po-dogovoru">Соглашение о внесении изменений в СРОКИ по Договору</a>                                    
                                </li>                               
                            </ul>
                        </li>
                        <li class="menu">
                            <a href="yuridicheskie-dokumenty.php" class="list-group-item  '.$item_dizaynproekt_Class.'">Дизайн - проект</a>
                             <ul class="list-group sub_menu">
                                <li class="menu2"><a class="list-group-item sub" href="#soglashenie-o-vnesenii-izmeneniy-v-stoimost-dogovora">Акт приема-передачи ДП на согласование</a>                                
                                </li>
                                <li class="menu2"><a class="list-group-item sub" href="#soglashenie-o-vnesenii-izmeneniy-v-sroki-po-dogovoru">Акт согласования ДП</a>                                    
                                </li> 
                                <li class="menu2"><a class="list-group-item sub" href="#soglashenie-o-vnesenii-izmeneniy-v-stoimost-dogovora">Письмо – запрос о предоставлении информации для создания ДП</a>                                
                                </li>
                                <li class="menu2"><a class="list-group-item sub" href="#soglashenie-o-vnesenii-izmeneniy-v-sroki-po-dogovoru">Письмо – запрос о уточнении согласования переданного ДП</a>                                    
                                </li>
                                <li class="menu2"><a class="list-group-item sub dblstr-xl" href="#soglashenie-o-vnesenii-izmeneniy-v-stoimost-dogovora">Письмо – запрос о необходимости внесения изменений в согласованный ДП, в связи с уточнениями от представителя Заказчика</a>                                
                                </li>
                                <li class="menu2"><a class="list-group-item sub" href="#soglashenie-o-vnesenii-izmeneniy-v-sroki-po-dogovoru">Протокол встречи (соглашение о доделках)</a>                                    
                                </li>                              
                            </ul>
                        </li>
