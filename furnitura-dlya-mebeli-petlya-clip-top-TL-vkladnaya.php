                    ...
                    <article    id="petli-dlya-fasadov-TL">
                      <section >
                        ...
                        <div class="bs-callout bs-callout-warning cont" > 
                            ...
                            <div class="main-box clearfix"  id="petlya-vkladnaya-TL" >   
                                  ...
                                  <div class="row" style="margin-bottom: 15px; margin-left: 15px;">
                                    <div class="row col-xs-12 col-sm-12 col-md-12" style="background: #fff;
                                        ...
                                        <div class="row col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">                                                           
                                            <div class="row">                                                
                                                <h3 class="blum">5000502-01-110</h3>
                                                <h3 class="blum">Петля вкладная для профильных дверей 95° CLIP top BLUMOTION без пружины 70T9750.TL, чашка петли: на шурупы</h3>
                                                <p> <a href="furnitura-dlya-mebeli-petlya-clip-top-vkladnaya.php#petlya-vkladnaya" >
