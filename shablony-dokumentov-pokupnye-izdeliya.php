...
?> 
                ...
                <div class="col-md-8 col-md-8-non" role="main">
                    <article itemscope="" itemtype="http://schema.org/Article">
                      <section itemprop="articleBody" id="bs-docs-section">
                        <div class="page-header">
                          <h1 itemprop="name" id="dveri-konstrukcii">Листы титульные дизайн-проекта</h1>
                        </div>
                    ...
                    <article itemscope="" itemtype="http://schema.org/Article">
                      <section itemprop="articleBody" id="bs-docs-section">
                        <div class="page-header">
                          <h1 itemprop="name" id="razdvizhnye-polotna">Листы титульные конструкторской документации</h1>
                        </div>
