...
/////////////////////////////////////
$svet=[];
$svet[0]=['path'=>"materialy-svet.php?node=lenta",//node
                'id'=>"#svet",
                'img'=> $path_img."tbssvet.png",//200x200 для поиска
                'keywords'=>"",
                'def'=>"СВЕТ"];    

$svet[1]=['path'=>"materialy-svet.php?node=lenta",
                'id'=> "#LED-lenta",
                'img'=> $path_img."tbs833_72_790-1.png", //200x200 для поиска
                'keywords'=>"",
                'def'=>"Светодиодная лента",  //описание для меню
...
$svet[2]=['path'=>"materialy-svet.php?node=profily",
...
$svet[3]=['path'=>"materialy-svet.php?node=transformatory",
                'id'=> "#transformatory",
...
$svet[4]=['path'=>"materialy-svet.php?node=accessories",
                'id'=> "#accessories",
                'img'=> $path_img."tbsJOK-004B-CR.png", //200x200 для поиска
                'keywords'=>"Аксессуары",
