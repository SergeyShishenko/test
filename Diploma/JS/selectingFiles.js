...
function onFilesSelect(e) {
  ...
  var files = e.target.files,
    // div, куда помещаятется таблица с информацией о файлах
  ...
  for(var i = 0; i < files.length; i++) {    
    ...
    // Если файд не изображение
    } else {
      // то вместо превью выводим соответствующею надпись
