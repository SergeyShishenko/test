...
$mail->Body = 'Здравствуйте, <b>'.$login.'</b>! <br/> <br/> Пожалуйста, подтвердите адрес электронной почты, 
и Вам будет доступна функция «Восстановление пароля». <br/> <br/> <a href="'.$base_url.$code.'">'.$base_url.$code.'</a><br><br>
С уважением,<br>
Служба поддержки пользователей проекта https://500stp.website
';
