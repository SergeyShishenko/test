    ...
    <article>
        <section>
            ...
            <div class="main-box clearfix">
                <h4> Виды мебельных петель </h4>
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/hSWQ0w1sB3M?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="main-box clearfix">
                <h4> Мебельная петля с встроенным доводчиком BLUM CLIP TOP BLUMOUTION </h4>
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
            ...
            <div class="main-box clearfix">
                ...
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/QUuvNqvQ4KM?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            ...
            <div class="main-box clearfix">
                <h4> Система петель CLIP top Blum</h4>
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/UF3CmneNbRY?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            ...
            <div class="main-box clearfix">
                ...
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/dwwZnO0SyTY?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="main-box clearfix">
                <h4> Blum - Петли 155 градусов</h4>
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/LhBYZdhJ6MM?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            ...
            <div class="main-box clearfix">
                ...
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/MYzHGTnlk9Y?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <h4> мебельные петли</h4>
            <div class="main-box clearfix">
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/PQsYw2j47lU?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            ...
            <div class="main-box clearfix">
                <h4> Виды петель Blum. Часть 1</h4>
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/tBTnpTt2W9k?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="main-box clearfix">
                <h4>Виды петель Blum. Часть 2</h4>
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/YC5lka6ymvw?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="main-box clearfix">
                <h4>Blum - Регулировка петель Clip Top Blumotion</h4>
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/yT7CDO4cajs?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            ...
            <div class="main-box clearfix">
                ...
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/LU69BB9a-lg?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="main-box clearfix">
                ...
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/0CiL1Kt5lDQ?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="main-box clearfix">
                ...
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/H0cSvxiaSUg?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="main-box clearfix">
                ...
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/ydWfS5U1FXg?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            ...
            <div class="main-box clearfix">
                ...
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/V66G70d80A4?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            ...
            <div class="main-box clearfix">
                ...
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/PVazJiCLemw?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            ...
            <div class="page-header">
                <h1 itemprop="name" id="petli-dlya-fasadov">Hettich</h1>
            ...
            <div class="main-box clearfix">
                ...
                <div class="main-box-body clearfix">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/Hjhe05CSfjo?rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
