                    ...
                    <article    id="styazhki-ekscentrikovye">
                      <section >
                        <div class="page-header"  >
                            <h1 itemprop="name" id="konfirmat">Стяжки эксцентриковые</h1>
                            <h2 >Конфирмат (стяжка-евровинт)</h2>                        
                        </div>
                                            ...
                                            <div class="row">                                                
                                                ...
                                                <table class="table table-striped table-responsive">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>Цвет&nbsp;/&nbsp;материал</th>
                                                            <th>Описание</th>                                                           
                                                            <th> <button type="button" id="each_addvpi" class="btn btn-primary" style="float:right;"><i class="fa fa-cart-plus fa-lg" aria-hidden="true"></i> ВПИ</button></th>
                                                        </tr>
                                                        </thead>
                                                        <tbody id="calcresult">
                                                        <tr>
                    ...
                    <div class="bs-sidebar hidden-print affix vertical-menu " role="complementary" >
                        ...
                        <li><a href="#styazhki-ekscentrikovye">Стяжки эксцентриковые</a>
                                <ul class="nav">
                                    ...
                                    <li><a href="#konfirmat">&#9999;&nbsp;Конфирматы 7.0х50 и 7.0х70</a></li>  
