                    ...
                    <article >
                      <section >
                        <div class="page-header  cont">
                          <h1 itemprop="name" id="vidy-obrabotki-kromki-stekla-zerkala">Виды обработки кромки стекла, зеркала </h1>
                            
                        </div>

                        <!-- <h2 id="polotno-bloka-dvernogo-gluhoe-pco">&nbsp;</h2> -->
                        <div class="bs-callout bs-callout-warning cont" >
                         <!-- <h4>Полотно блока дверного глухое <abbr title="Прозрачный Цикл Отделки">ПЦО</abbr></h4> -->
                                               
                        <p><a>
                        <img src="./dist/images/vidy-obrabotki-kromki-stekla-zerkala-foto.png" class="center-block img-rounded img-thumbnail"
                                data-toggle="modal"
                                data-target="#myModal"                                                         
                                alt="vidy-obrabotki-kromki-stekla-zerkala-foto.png"
                                data-dwg="non"
                           ></a>
                       </p>
                       ...
                       <p><a>
                        <img src="./dist/images/vidy-obrabotki-kromki-stekla-zerkala-eskizy.png" class="center-block img-rounded img-thumbnail"
                                data-toggle="modal"
                                data-target="#myModal"                                                         
                                alt="vidy-obrabotki-kromki-stekla-zerkala-eskizy.png"
                                data-dwg="non"
                           ></a>
                       </p>
                       <div class="overlay"></div>
                ...
                <div class="col-md-2" id="navmain-izdeliya">
                    <div class="bs-sidebar hidden-print affix vertical-menu " role="complementary"  >
                        <ul class="nav bs-sidenav">
                            <li><a href="#vidy-obrabotki-kromki-stekla-zerkala">Виды обработки кромки стекла, зеркала</a>
                            </li>
