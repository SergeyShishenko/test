                                ...
                                <div class=" col-xs-12 col-sm-12 col-md-12">
                                    <div class="row col-xs-12 col-sm-12 col-md-12" style="background: #fff;
                                         ...
                                         <ul id="myTab" class="nav nav-tabs" style="margin-bottom: 15px;">
                                            ...
                                            <li class=""><a href="#calc" data-toggle="tab">Калькулятор</a></li>
                                                ...
                                                <div class="row col-xs-12 col-sm-12 col-md-12">
                                                    ...
                                                    <table class="table  table-responsive">                                                       
                                                        <tbody>                                                        
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a class="thumbb" href="#" data-image-id="" data-toggle="modal" data-title="Обработка ящиков" data-image="./dist/filesdb/images/MovStab1.png" data-target="#image-gallery">
                                                                    <img src="./dist/filesdb/images/MovStab1.png" class="col-xs-12 col-sm-12 col-md-12" alt="Комплект бокового стабилизатора" title="">
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <a class="thumbb" href="#" data-image-id="" data-toggle="modal" data-title="Обработка ящиков" data-image="./dist/filesdb/images/MovStab3.png" data-target="#image-gallery">
                                                                    <img src="./dist/filesdb/images/MovStab3.png" class="col-xs-12 col-sm-12 col-md-12" alt="Проектирование" title="">
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                <a class="thumbb" href="#" data-image-id="" data-toggle="modal" data-title="Обработка ящиков" data-image="./dist/filesdb/images/MovStab2.png" data-target="#image-gallery">
                                                                    <img src="./dist/filesdb/images/MovStab2.png" class="col-xs-12 col-sm-12 col-md-12" alt="Комплект бокового стабилизатора" title="">
                                                                    </a>
                                                                </td>
