...
$LEVEL2 = array( array( "name" => "ПРОФИЛИ ГЛАДКИЕ", 
                         ...
                         "LEVEL3" => array( array( "name" => "Накладки",
                                                    ...
                                                    "LEVEL4" => array( array( "name" => "МДФ накладка №050/ДШ",                         
                                                                        ...
                                                                        array(  "name" => "МДФ накладка №053/ДШ",
                                                                                "id" => "mdf-profili-nakladki-53",
                                                                                "KEYWORDS" => array()
                                                                           )
                                                ...
                                                array( "name" => "Под ротанговую сетку",
                                                        "TD-id" => "footer46",                    
                                                        "id" => "floating47",                                                    
                                                        "data-href" => "detali-profili.php#profili-nakladki",
                                                        "data-img" => "./dist/images/no-175x0.jpg",                         
...
echo "<h1>TABLE</h1>";
    ...
    for ($row2 = 0; $row2 < count($LEVEL2); $row2++) { 
        ...
        for ($row3 = 0; $row3 < count($LEVEL3); $row3++) { 
            ...
            echo '  </TD>                                                                            
                    ...
                    for ($row4 = 0; $row4 < count($LEVEL4); $row4++) {    
                        ...
                        echo '        </TD>'; 
                            if ($row4 < count($LEVEL4)-1){
                            echo '    </TR><TD></TD></TR> <!--end LEVEL4--> '; 
                            }                               
                    }
                    echo "</TABLE>";    
                echo ' </TD>
                    ...
                    if ($row3 < count($LEVEL3)-1){
                        echo '    <TR><TD> &nbsp; </TD><TD></TD></TR> <!--end LEVEL3-->' ; 
                        }                    
        ...
        echo ' </TD>
            ...
            if ($row2 < count($LEVEL2)-1){
                echo ' <TR><TD> &nbsp; </TD><TD></TD></TR> <!--end LEVEL2-->' ; 
                }
