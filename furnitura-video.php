                    ...
                    <article  >
                     ...
                     <!-- <h2 >Видео с Ютуба</h2>    -->
                        ...
                        <div class="main-box clearfix"> 
                            ...
                            <div class="main-box-body clearfix"> 
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/S5nQqMojH5c?rel=0" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                        <div class="main-box clearfix">  
                        <h4 > Система петель CLIP top Blum</h4 >                            
                            <div class="main-box-body clearfix"> 
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/UF3CmneNbRY?rel=0" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                        <div class="main-box clearfix">  
                        <h4 > Петля Sensys 8639i, угол корпуса W30, угол 95°, чашка TH52 Ø35, вкладная навеска B 16</h4 >                           
                            <div class="main-box-body clearfix"> 
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/dwwZnO0SyTY?rel=0" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                        <div class="main-box clearfix">  
                        <h4 > Blum - Петли 155 градусов</h4 >                           
                            <div class="main-box-body clearfix"> 
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/LhBYZdhJ6MM?rel=0" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>

                        <div class="main-box clearfix"> 
                        <h4 > Мебельные петли, и «с чем их едят» l Виды l Разметка l Количество петель на фасад l Unreal Engine 4</h4 >                            
                            <div class="main-box-body clearfix"> 
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/MYzHGTnlk9Y?rel=0" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="main-box clearfix">                            
                            <div class="main-box-body clearfix"> 
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/PQsYw2j47lU?rel=0" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                        ...
                        <h4 > Виды петель Blum. Часть 1</h4 >                            
                            <div class="main-box-body clearfix"> 
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/tBTnpTt2W9k?rel=0" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                        <div class="main-box clearfix"> 
                        <h4 >Виды петель Blum. Часть 2</h4 >                            
                            <div class="main-box-body clearfix"> 
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/YC5lka6ymvw?rel=0" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                        <div class="main-box clearfix"> 
                        <h4 >Blum - Регулировка петель Clip Top Blumotion</h4 >                            
                            <div class="main-box-body clearfix"> 
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/yT7CDO4cajs?rel=0" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
