                    ...
                    <article    id="sistemy-napravlyayushchih-movento">
                      <section >
                        <div class="page-header"     >
                          <h1 itemprop="name" id="movento-s-blumotion-760h-shelf">Системы направляющих MOVENTO</h1>
                          <h2 > MOVENTO с BLUMOTION – 760H – монтаж ко дну корпуса – выдвижная полка</h2>
                        </div>
                                    ...
                                    <div id="carousel" class="carousel slide" data-ride="carousel" style="display: inline-block;">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="item active">
                                             <a class="thumbb" href="#" data-image-id="" data-toggle="modal" data-title="MOVENTO с BLUMOTION – 760H – монтаж ко дну корпуса – стандартный ящик" data-image="./dist/images/Movento760hs1.png" data-target="#image-gallery">
                                                    <img  
                                                        src="./dist/images/Movento760hs1.png"
                                                        data-src="./dist/images/Movento760hs1.png"
                                            ...
                                            <div class="item">
                                                <a class="thumbb" href="#" data-image-id="" data-toggle="modal" data-title="Необходимое пространство" data-image="./dist/images/Movento760hs22.png" data-target="#image-gallery">
                                                    <img  
                                                        src="./dist/images/Movento760hs22.png"
                                                        data-src="./dist/images/Movento760hs22.png"
                                                        class="center-block   img-rounded     bar "
                                                        data-toggle="modal"                                                                                                                          
                                            ...
                                            <div class="item">
                                                <a class="thumbb" href="#" data-image-id="" data-toggle="modal" data-title="Информация для заказа" data-image="./dist/images/Movento760hs2.png" data-target="#image-gallery">
                                                    <img  
                                                        src="./dist/images/Movento760hs2.png"
                                                        data-src="./dist/images/Movento760hs2.png"
                                                        class="center-block   img-rounded     bar "
                                                        data-toggle="modal"                                                                                                                          
                                            ...
                                            <div class="item">
                                                <a class="thumbb" href="#" data-image-id="" data-toggle="modal" data-title="Монтаж к корпусу" data-image="./dist/images/Movento760hs33.png" data-target="#image-gallery">
                                                    <img  
                                                        src="./dist/images/Movento760hs33.png" 
                                                        data-src="./dist/images/Movento760hs33.png"
                                                        class="center-block   img-rounded     bar "
                                                        data-toggle="modal"                                                                                                                         
                                            ...
                                            <div class="item">
                                                <a class="thumbb" href="#" data-image-id="" data-toggle="modal" data-title="Проектирование" data-image="./dist/images/Movento760hs3.png" data-target="#image-gallery">
                                                    <img  
                                                        src="./dist/images/Movento760hs3.png" 
                                                        data-src="./dist/images/Movento760hs3.png"
                                                        class="center-block   img-rounded     bar "
                                                        data-toggle="modal"                                                                                                                         
                                                        alt="Проектирование"                                                        
                                                    >
                                            ...
                                            <div class="item">
                                                <a class="thumbb" href="#" data-image-id="" data-toggle="modal" data-title="Проектирование" data-image="./dist/images/Movento760hs4.png" data-target="#image-gallery">
                                                    <img  
                                                        src="./dist/images/Movento760hs4.png" 
                                                        data-src="./dist/images/Movento760hs4.png"
                                                        class="center-block   img-rounded     bar "
                                                        data-toggle="modal"                                                                                                                         
                                                        alt="Проектирование"                                                        
                                                    >
                                            ...
                                            <div class="item">
                                                <a class="thumbb" href="#" data-image-id="" data-toggle="modal" data-title="Позиции крепления – направляющие к корпусу" data-image="./dist/images/Movento760H5.png" data-target="#image-gallery">
                                                    <img  
                                                        src="./dist/images/Movento760H5.png" 
                                                        data-src="./dist/images/Movento760H5.png"
                                                        class="center-block   img-rounded     bar "
                                                        data-toggle="modal"                                                                                                                         
                                            ...
                                            <div class="item">
                                                <a class="thumbb" href="#" data-image-id="" data-toggle="modal" data-title="Обработка ящиков" data-image="./dist/images/Movento760hs8.png" data-target="#image-gallery">
                                                    <img  
                                                        src="./dist/images/Movento760hs8.png" 
                                                        data-src="./dist/images/Movento760hs8.png"
                                                        class="center-block   img-rounded     bar "
                                                        data-toggle="modal"                                                                                                                         
                                            ...
                                            <div class="tab-pane fade  in active" id="movart760-2">
                                                <div class="row col-xs-12 col-sm-12 col-md-12">
                                                    ...
                                                    <table class="table table-striped table-responsive">
                                                        ...
                                                        <tr>
                                                            <td><img src="./dist/filesdb/images/pagevpi/ArticulImgU3.png" class="" alt="Задний держатель" title=""></td>
                                                            <td>2</td>
                                                            <td>T51.7000.01</td>
                                                            <td>Нейтральный</td>
                                                            <td>Задний держатель для выдвижной полки</td>
                                                        </tr>
                        ...
                        <ul class="nav bs-sidenav">
                            ...
                            <li><a href="#sistemy-napravlyayushchih-movento">Системы направляющих MOVENTO</a>
                                <ul class="nav">
                                    ...
                                    <li><a href="#movento-s-blumotion-760h-shelf">&#9999;&nbsp;MOVENTO с BLUMOTION – 760H – монтаж ко дну корпуса – выдвижная полка</a></li>                                                                                                
                                </ul>
                            </li>
