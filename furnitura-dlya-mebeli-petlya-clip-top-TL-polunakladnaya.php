                    ...
                    <article    id="petli-dlya-fasadov-TL">
                      <section >
                        ...
                        <div class="bs-callout bs-callout-warning cont" > 
                            ...
                            <div class="main-box clearfix"  id="petlya-polunakladnaya-TL" >   
                                  ...
                                  <div class="row" style="margin-bottom: 15px; margin-left: 15px;">
                                    <div class="row col-xs-12 col-sm-12 col-md-12" style="background: #fff;
                                        ...
                                        <div class="row col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">                                                           
                                            <div class="row">                                                
                                                <h3 class="blum">5000502-01-112</h3>
                                                <h3 class="blum">Петля полунакладная для профильных дверей 95° CLIP top BLUMOTION без пружины 70T9650.TL, чашка петли: на шурупы</h3>
                                                <p> <a href="furnitura-dlya-mebeli-petlya-clip-top-polunakladnaya.php#petlya-polunakladnaya" >
                                                ...
                                                <table class="table table-striped table-responsive">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>1</td>
                                                            <td class="animated" data-objfurnid="32"><a href="https://publications.blum.com/2018/catalogue/ru/110/#zoom=z" target="_blank">70T9650.TL</a></td>
                                                            <td>Металл</td> 
                                                            <td colspan="3">пeтля полунакладная CLIP top BLUMOTION без пружины</td>
                                                        </tr>
                                                        <tr>
