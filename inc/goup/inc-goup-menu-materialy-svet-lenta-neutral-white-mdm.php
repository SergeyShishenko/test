...
$path_page="materialy-svet.php?group=mdm&node=lenta_neutral_white_mdm";
$component_data="inc/ComponentData/materialy/svet/arlight/lenta_neutral_white/";
$id="#LED-lenta-neutral";
$num=0;
/////////////////////////////////////  КЛЮЧИ МАССИВА ИСПРАВИТЬ В ВЕРХНИЙ РЕГИСТР
$lenta_neutral_white_mdm=[];
$lenta_neutral_white_mdm[$num]=[
        'path'=>$path_page,//node
        'id'=>$id."-main",
        'img'=> $path_img."tbssvet.png",//200x200 для поиска
        'keywords'=>"",
        'def'=>"СВЕТОДИОДНАЯ ЛЕНТА, НЕЙТРАЛЬНЫЙ БЕЛЫЙ 4000&#8209;4500К, МДМ&#8209;КОМПЛЕКТ"
];    
$num++;
$lenta_neutral_white_mdm[$num]=[
        'path'=>$path_page,
