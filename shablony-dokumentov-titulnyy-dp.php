                ...
                <div class="col-md-8 col-md-8-non" role="main" id="main-page">
                      ...
                      <section >
                        ...
                        <div class="bs-callout bs-callout-warning cont" ><h4>Лист титульный ДП</h4>
                            ...
                            <p> <a>
                                ...
                                <img  src=data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==  data-src="./dist/images/shablon-alboma-dp_1-v3.png" class="center-block img-rounded img-thumbnail b-lazy img-album"
                                 data-toggle="modal"
                                 data-target="#myModal"
                    ...
                    <article >
                      <section >
                        <div class="page-header">
                        <h2  id="info_o_teh">&nbsp;</h2> 
                          <h1 itemprop="name">Техническое Задание на проектирование, предоставляемой Заказчиком</h1>
                        </div>
                        <!-- <h2 id="dok--385">&nbsp;</h2> -->
                        <div class="bs-callout bs-callout-warning cont" >
                            <!-- <h4>Док. № 385</h4> -->
