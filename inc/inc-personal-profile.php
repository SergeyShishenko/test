...
<div style="position:fixed; left:0; top:80px; " class="btn-side">
    ...
    <div class="btn-group  ">
        <button type="button" class="btn btn-default  animated tada user-toggle " aria-haspopup="true"
            aria-expanded="false">
            <span class="glyphicon glyphicon-user <?php echo $class_info_alert;?>"></span>
        </button>
        <div class="profile"
            style="position: absolute; transform: translate3d(45px, 0px, 0px); top: 0px; left: 0px; z-index: 1100; background-color: #ffffff;">
            ...
            <ul class="user ">
                ...
                <?php if($role !="guest"){ ?>
                <li class="sett">
                    <div class="btn btn-default" data-toggle="collapse" href="#collapseSetting" role="button"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group  has-success has-feedback">
                                        ...
                                        <input type="password" class="form-control" id="password"
                                            aria-describedby="password" style="display:inline-block;">
                                    ...
                                    <div class="form-group  has-success has-feedback">
                                        ...
                                        <input type="password" class="form-control" id="password-check"
                                            aria-describedby="password-check" style="display:inline-block;">
                                ...
                                <div class="form-group">
                                    <div class="">
                                        <button type="submit" class="btn btn-success "
                                            onclick="changepass();"><b>Сохранить</b></button>
                            ...
                            <div id="emailaccess">
                                <div class="form-group">
                                    <div class="form-group  has-success has-feedback ">
                                        ...
                                        <input type="email" class="form-control edit" id="email-check"
                                            aria-describedby="email-check" style="display:inline-block;" readonly
                                            value="<?php echo $email?>">
                                        <label for="email-check" id="emailedit" class="tool" data-toggle="tooltip"
                                            data-placement="left" title="Редактировать" onclick='emailedit();'></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group  has-success has-feedback ">
                                        ...
                                        <input type="email" class="form-control " id="email-check"
                                            aria-describedby="email-check" style="display:inline-block;" required
                                            value="<?php echo $email?>">
                                        ...
                                        <label for="email-check" id="question" class="tool" data-toggle="tooltip"
                                            data-placement="left" title="Восстановление пароля"></label>
                                        <!-- <label for="email-check" id="emailedit"  class="tool" data-toggle="tooltip" data-placement="left" title="Редактировать" onclick='emailedit();' style="display: none;"></label>   -->
                                        <label for="email-check" id="emailedit" class="tool" data-toggle="tooltip"
                                            data-placement="left" title="Редактировать" onclick='emailedit();'
                                    ...
                                    <div class="form-group" id="activationmail">
                                        <div>
                                            <button type="submit" class="btn btn-success " id="subemail"
                                                onclick='emailaccess();'><b>Подтвердить</b></button>
                ...
                <li>
                    <button type="button" class="btn btn-default " title="Новости" data-toggle="collapse"
                        href="#collapseInfo" role="button" aria-expanded="false" aria-controls="collapseInfo">
                        <span class="glyphicon glyphicon-info-sign <?php echo $class_info_alert;?>"><span>
                    ...
                    <div class="collapse" id="collapseInfo">
                        ...
                        <div class="card card-body">
                            Зарегистрируйте свою электронную почту, и Вам будет доступна функция<br><b>«Восстановление
                                пароля»</b> !
                        </div>
                ...
                <?php if($role !="guest"){ ?>
                <li>
                    <button type="button" class="btn btn-default link" data-toggle="modal" data-target="#mySendModal"
