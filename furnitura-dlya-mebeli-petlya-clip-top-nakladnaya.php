                    ...
                    <article    id="petli-dlya-fasadov">
                      <section >
                        ...
                        <div class="bs-callout bs-callout-warning cont" > 
                            ...
                            <div class="main-box clearfix"  id="petlya-nakladnaya" >   
                                  ...
                                  <div class="row" style="margin-bottom: 15px; margin-left: 15px;">
                                    <div class="row col-xs-12 col-sm-12 col-md-12" style="background: #fff;
                                        ...
                                        <div class="row col-xs-12 col-sm-12 col-md-12" style="margin-top: 20px;">                                                           
                                            <div class="row">                                                
                                                <h3 class="blum">5000502-01-101</h3>
                                                <h3 class="blum">Петля накладная для профильных дверей 95° CLIP top BLUMOTION 71B9550, чашка петли: на шурупы</h3>
                                                <p> <a href="furnitura-dlya-mebeli-petlya-clip-top-TL-nakladnaya.php#petlya-nakladnaya-TL" >
                                                ...
                                                <table class="table table-striped table-responsive">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>1</td>
                                                            <td class="animated" data-objfurnid="26"><a href="https://publications.blum.com/2018/catalogue/ru/110/#zoom=z" target="_blank">71B9550</a></td>
                                                            <td>Металл</td> 
                                                            <td colspan="3">пeтля накладная CLIP top BLUMOTION</td>
                                                        </tr>
                                                        <tr>
